...
const peoplesForRemoveElem = people.slice();
console.log(people);
console.log(peoplesForRemoveElem);
...
//     1. `shift()` 활용
// peoplesForRemoveElem.shift();
// peoplesForRemoveElem.shift();
//     2. `splice()` 활용
// peoplesForRemoveElem.splice(0, 2);
// 5. people 배열 끝 위치에서 '장영실', '신사임당'을 제거합니다.
//     1. `pop()` 활용
// peoplesForRemoveElem.pop();
// peoplesForRemoveElem.pop();
//     2. `splice()` 활용
// peoplesForRemoveElem.splice(peoplesForRemoveElem.length - 3, 2);
