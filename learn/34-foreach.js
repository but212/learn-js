...
//     console.log("과일 바구니 안", index + 1, "번쨰 과일은", fruit);
//   });
// }

{
  ...
  players.forEach((player, index) => {
    if (player.name === "안정환") {
      console.log(player.name, "is number", index);
    }
  });

  let ahnsIndex = players.findIndex((player) => player.name === "안정환");
  console.log(ahnsIndex);
}
